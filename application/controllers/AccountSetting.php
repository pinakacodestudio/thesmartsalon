...
class AccountSetting extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('AccountSetting',$params);
    }
    ...
    public function savepass()
    {
		...
		if ($this->form_validation->run()) {
            ...
            if ($password === true) {
                ...
                if ($this->Queries->updateRecord(TBL_USERINFO, $form_data, $userid)): $this->session->set_flashdata('success_msg', 'Password Changed Successfully');
                else: $this->session->set_flashdata('error_msg', 'Failed To Update Password');
                endif;
            } else {
