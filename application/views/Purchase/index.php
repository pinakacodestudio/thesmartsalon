...
if ($id != 0 && is_numeric($id)) {
    ...
    $val_managername = $purchase->managerid;
}
...
<body class="dashboard-page sb-l-o sb-l-m">
                            ...
                            <div class="panel-body admin-form">
                                <form action="<?= $savePage; ?>" method="post">
                                    ...
                                    if ($this->session->userdata['logged_in']['user_type'] < 3) :
                                        dropdownbox('Manager Name*', 'managername1', $managername, $val_managername, 'required');
                                    endif;
                                    echo '</div></div>';
                                    ?>
    ...
    <script type="text/javascript">
        ...
        function calTotal() {
            ...
            var charges = parseFloat($("#shipping").val());
        ...
        $(document).ready(function() {
            ...
            $(".addPurchase").click(function(e) {
                ...
                var managername1 = $("#managername1 option:selected").val();
                if (billno == "") {
