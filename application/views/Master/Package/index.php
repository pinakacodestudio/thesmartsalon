...
$addPage = base_url() . "Master/Package/add/";
                            ...
                            <div class="" id="spy2">
                                <div class="panel-heading">
                                    <div class="panel-title hidden-xs">
                                        ...
                                        <?= $managePage; ?>
                                        <button class="btn btn-primary btn-sm pull-right mt5" onclick="window.location.href='<?= $addPage ?>'"> <i class="ti-plus"></i> Add Package</button>
                                    </div>
                                </div>
