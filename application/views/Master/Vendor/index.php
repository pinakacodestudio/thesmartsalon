...
$addPage = base_url() . "Master/Vendor/index/";
$deletePage = base_url() . "Master/Vendor/delete/";
$mainPage = base_url() . "Master/Vendor/";
$pageSave = base_url() . "Master/Vendor/save/";
$pageBack = base_url() . "Master/Vendor/";
                            ...
                            <div class="admin-form theme-primary">
                                ...
                                <div class="panel heading-border panel-primary">
                                    <div class="panel-body bg-light">
                                        ...
                                        editbox("Vendor Email", "email", "Enter Vendor Email", $val_vendor_email, '');
                                        editbox("Mobile", "mobile", "Enter Mobile No.", $val_mobile, 'required pattern="[6789][0-9]{9}" ');
                                        editbox("Phone", "phone", "Enter Phone No.", $val_phone, ' pattern="\d*"');
