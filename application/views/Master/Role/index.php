<?php
$managePage = 'Role';
$addPage = base_url() . "Master/Role/index/";
$deletePage = base_url() . "Master/Role/delete/";
$mainPage = base_url() . "Master/Role/";
$pageSave = base_url() . "Master/Role/save/";
$pageBack = base_url() . "Master/Role/";
// --------------------- Edit -----------------------//
$activate = "checked";
$id = $role->id;
if ($id != "" && $id != 0) {
