<?php
$mainPage = base_url() . "Report/Product/";
$ses_staffid = $this->session->userdata['productreport']['staffid'];
$ses_source = $this->session->userdata['productreport']['source'];
$ses_start = $this->session->userdata['productreport']['start'];
$ses_end = $this->session->userdata['productreport']['end'];
$managePage = "Product Report";
?>
<!DOCTYPE html>
<html>
                    ...
                    <div class="col-lg-3 col-md-3">
                        <div class="panel panel-default panel-border top">
                            ...
                            <div class="panel-body admin-form">
                                ...
                                dropdownbox("Products", "product", $productlist, $ses_source);
