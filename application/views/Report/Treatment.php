<?php
$mainPage = base_url() . "Report/Treatment/";
$ses_staffid = $this->session->userdata['treatmentreport']['staffid'];
$ses_source = $this->session->userdata['treatmentreport']['source'];
$ses_start = $this->session->userdata['treatmentreport']['start'];
$ses_end = $this->session->userdata['treatmentreport']['end'];
$managePage = "Treatment Report";
?>
<!DOCTYPE html>
<html>
                    ...
                    <div class="col-lg-3 col-md-3">
                        <div class="panel panel-default panel-border top">
                            ...
                            <div class="panel-body admin-form">
                                ...
                                dropdownbox("Treatments", "treatment", $treatlist, $ses_source);
