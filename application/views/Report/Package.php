<?php
$mainPage = base_url() . "Report/Package/";
$ses_staffid = $this->session->userdata['packagereport']['staffid'];
$ses_source = $this->session->userdata['packagereport']['source'];
$ses_start = $this->session->userdata['packagereport']['start'];
$ses_end = $this->session->userdata['packagereport']['end'];
$managePage = "Package Report";
?>
<!DOCTYPE html>
<html>
                    ...
                    <div class="col-lg-3 col-md-3">
                        <div class="panel panel-default panel-border top">
                            ...
                            <div class="panel-body admin-form">
                                ...
                                dropdownbox("Package Name", "package", $packagelist, $ses_source);
