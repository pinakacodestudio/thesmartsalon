                            ...
                            <div class="admin-form theme-primary">
                                ...
                                <div class="panel heading-border panel-primary">
                                    <div class="panel-body bg-light">
                                        ...
                                        editbox("Contact Number", "cnumber", "Enter Contact Number", $val_mobile, 'required pattern="[6789][0-9]{9}"');
                                        echo "</div><div class='col-md-3'>";
                                        editbox('Member Id', 'memberid', 'Enter Member Id', $val_customerid);
                                        echo "</div> <div class='col-md-3'>";
                                        editbox("Address", "addr", "Enter Address", $val_address);
                                        echo "</div></div><div class='row'> <div class='col-md-3'>";
                                        editbox("Enquiry For", "efor", "services / products / packages ", $val_efor, '');
                                        echo "</div> <div class='col-md-3'>";
                                        ...
                                        <?php if (count($enquirylist)) : ?>
                                            <?php
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php
                                                                if ($post->leadstatus != 1) {
                                                                    if (check_role_assigned('enquiry', 'edit')) {

                                                                        echo anchor($customerPage . $post->id, '<span style="valign:center">Convert To Customer</span>', ['class' => 'label label-info', 'style' => 'float:left;margin-right:5px;']);
