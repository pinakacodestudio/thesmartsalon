<?php
$managePage = 'Manage Product Import';
$pageSave = base_url() . "ImportData/uploadProduct/";
$mainPage = base_url() . "ImportData/Product/";
$operation = "Import Product";
?>
<!DOCTYPE html>
<html>
                            ...
                            <div class="admin-form theme-primary">
                                ...
                                <div class="panel heading-border panel-primary">
                                    <div class="panel-body bg-light">
                                        ...
                                        <?php
                                        uploadbox('12', 'Upload Product Data', 'filename', 'Upload Product Data', '.xlsx');
                                        echo '<div class="clearfix"></div>';
                                        dropdownbox('Product Company', 'company', $complist, $val_company, 'required');
                                        ?>
