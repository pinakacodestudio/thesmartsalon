<?php
$managePage = 'Manage Customer Import';
$pageSave = base_url() . "ImportData/uploadCustomer/";
$mainPage = base_url() . "ImportData/Customer/";
                            ...
                            <div class="admin-form theme-primary">
                                ...
                                <div class="panel heading-border panel-primary">
                                    <div class="panel-body bg-light">
                                        ...
                                        uploadbox('12', 'Upload Customer Data', 'filename', 'Upload Customer Data', '.xlsx');
