<?php
$managePage = 'Manage Enquiry Import';
$pageSave = base_url() . "ImportData/uploadEnquiry/";
$mainPage = base_url() . "ImportData/Enquiry/";
$operation = "Import Enquiry";
?>
<!DOCTYPE html>
<html>
                            ...
                            <div class="admin-form theme-primary">
                                ...
                                <div class="panel heading-border panel-primary">
                                    <div class="panel-body bg-light">
                                        ...
                                        <?php
                                        uploadbox('12', 'Upload Enquiry Data', 'filename', 'Upload Enquiry Data', '.xlsx');
                                        echo '<div class="clearfix"></div>';
                                        dropdownbox('Enquiry Source', 'sourceid', $sourcelist, $val_source, 'required');
                                        echo '<div class="clearfix"></div>';
