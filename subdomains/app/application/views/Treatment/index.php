...
$addPage = base_url() . "Treatment/index/";
$deletePage = base_url() . "Treatment/delete/";
$mainPage = base_url() . "Treatment/";
$pageSave = base_url() . "Treatment/save/";
$pageBack = base_url() . "Treatment/";
